...
export const serviceDetails: Record<string, ServiceDetail> = {
  ...
  "relocatable-spaces": {
    ...
    benefitsSectionSubtitle: "Explore what makes relocatable spaces a practical and efficient solution for modern space requirements.",
    benefits: [
      { icon: "LayoutGrid", title: "Suitable for Multiple Applications", description: "Ideal for retail stores, cafés, kiosk, classrooms, healthcare units, security cabins, exhibition spaces, studios, gyms, and other flexible space requirements" },
      { icon: "RefreshCcw", title: "Relocate Without Rebuilding", description: "Move your entire space to a new location while maintaining the same quality, functionality, and comfort without starting from scratch." },
      { icon: "Clock", title: "Temporary or Permanent Use", description: "Suitable for both short-term deployments and long-term installations without compromising comfort, functionality, or durability." },
      { icon: "Sliders", title: "Multi-Functional Spaces", description: "A single space can be designed to accommodate multiple activities, helping maximize usability and adaptability." },
      { icon: "TrendingUp", title: "Scalable for Changing Needs", description: "Easily expand, reconfigure, or combine units as your requirements grow over time" },
      { icon: "MapPin", title: "Built for Diverse Environments", description: "Designed to perform reliably across urban, rural, industrial, commercial, and remote locations with equal efficiency." },
    ],
    includesSectionTitle: "What's Included In Your Relocatable Space?",
    includesSectionSubtitle: "Every THERMANEST relocatable space is thoughtfully designed to combine comfort, quality, and flexibility for a wide range of applications and environments.",
    includesSectionIcon: "Truck",
    includesCtaLabel: "Deploy Your Modular Space",
    includesItems: [
      { title: "Custom Configurations", description: "Flexible layouts, branding options, interior finishes, partitions, and application-specific features designed to meet your unique requirements." },
      { title: "Fully Finished Interiors", description: "Thoughtfully designed interiors with flooring, wall finishes, storage solutions, and furniture options tailored to the intended use." },
      { title: "Integrated Utility Systems", description: "Built-in electrical, lighting, plumbing, sewage and essential utility systems designed for a seamless experience." },
    ],
    gallerySectionTitle: "Designed For Every Possibility",
    gallerySectionSubtitle: "Discover how relocatable spaces can be adapted for different purposes. The spaces shown below are just a few examples, with countless other possibilities waiting to be explored.",
    gallery: [
      { image: "/images/new/image41.png", label: "SECURITY CABIN" },
      { image: "/images/new/image43.png", label: "LEARNING CENTER" },
      { image: "/images/new/image44.png", label: "RETAIL OUTLET" },
      { image: "/images/new/image42.png", label: "YOGA STUDIO" },
      { image: "/images/new/image46.png", label: "HEALTHCARE UNIT" },
    ],
  },
};
